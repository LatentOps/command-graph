...
def test_runtime_integration_evaluation_exercises_process_boundaries(tmp_path, monkeypatch):
    ...
    assert payload["evidence_linkage"]["observation_cases"] == 7
